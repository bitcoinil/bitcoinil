...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 120;
        consensus.BIP34Hash = uint256S("0x00000ee07576af516cd03c5aa84e05d17930912c1c7059885aed0f51a4faaa42");
        consensus.BIP65Height = 300; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 300; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
        consensus.CSVHeight = 300; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5
        consensus.SegwitHeight = 300; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        ...
        genesis = CreateGenesisBlock(1617202664, 360206, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000d53b2d551fa1638333b80ca694fbfa021643d00f2e237f4021652cc61ea"));
        assert(genesis.hashMerkleRoot == uint256S("0xe698eae92b0d33208ab3e087450fed7be77e4d12d232d7b4463edd889b0cd380"));
        ...
        checkpointData = {
            {
                {     0, uint256S("0x00000d53b2d551fa1638333b80ca694fbfa021643d00f2e237f4021652cc61ea")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1617202647, 57021, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000542e911899b1a0777c88d7f8eba4bd2ec0e8d4a691b0fc3e6d07f2af4fd"));
        assert(genesis.hashMerkleRoot == uint256S("0xe698eae92b0d33208ab3e087450fed7be77e4d12d232d7b4463edd889b0cd380"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000542e911899b1a0777c88d7f8eba4bd2ec0e8d4a691b0fc3e6d07f2af4fd")},
            }
        };
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1617202594, 2743635, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000003c224878f8d5c322a2b8b190392617909fe510b91ce8bce3b2306d6b479"));
        assert(genesis.hashMerkleRoot == uint256S("0xe698eae92b0d33208ab3e087450fed7be77e4d12d232d7b4463edd889b0cd380"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1617202520, 75354, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000c2dcadec7084eedc04fb32fa1869761cc8f68abc6ee79bd900a49dec67b"));
        assert(genesis.hashMerkleRoot == uint256S("0xe698eae92b0d33208ab3e087450fed7be77e4d12d232d7b4463edd889b0cd380"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000c2dcadec7084eedc04fb32fa1869761cc8f68abc6ee79bd900a49dec67b")},
            }
        };
