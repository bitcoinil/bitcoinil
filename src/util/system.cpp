...
const char * const BITCOIN_CONF_FILENAME = "bitcoinil.conf";
 ...
 * https://github.com/bitcoinil/bitcoinil/pull/16097#issuecomment-514627823
 */
...
#else
    const char* pszModule = "bitcoinil";
#endif
    if (pex)
        return strprintf(
...
{
    // Windows: C:\Users\Username\AppData\Roaming\BitcoinIL
    // macOS: ~/Library/Application Support/BitcoinIL
    // Unix-like: ~/.bitcoinil
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitcoinIL";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/BitcoinIL";
#else
    // Unix-like
    return pathRet / ".bitcoinil";
#endif
#endif
}
