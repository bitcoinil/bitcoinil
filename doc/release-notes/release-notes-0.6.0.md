...
https://github.com/bitcoinil/bitcoinil/tarball/v0.6.0  # .tar.gz
https://github.com/bitcoinil/bitcoinil/zipball/v0.6.0  # .zip
...
Support for clicking on bitcoinil: URIs and
opening/launching Bitcoin-Qt is available only on Linux,
and only if you configure your desktop to launch
Bitcoin-Qt. All platforms support dragging and dropping
bitcoinil: URIs onto the Bitcoin-Qt window to start
payment.
