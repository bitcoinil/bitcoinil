...
randomly crashing on Windows XP. It is [not clear](https://github.com/bitcoinil/bitcoinil/issues/7681#issuecomment-217439891)
...
[Pull request](https://github.com/bitcoinil/bitcoinil/pull/8035/files), [BIP 32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/bitcoinil/bitcoinil/pull/7762).
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use BTCIL/kB (MarcoFalke)
