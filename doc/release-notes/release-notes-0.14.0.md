...
now ZMQ can be used on Windows. Please see [this document](https://github.com/bitcoinil/bitcoinil/blob/master/doc/zmq.md) for
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/bitcoinil/bitcoinil/pull/8753)
...
### Documentation
- #8223 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
