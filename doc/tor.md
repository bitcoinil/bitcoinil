...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 8224 127.0.0.1:8225
	HiddenServicePort 18224 127.0.0.1:18225

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (8224 by default), and target addresses and ports
should be equal to binding address and port for inbound Tor connections (127.0.0.1:8225 by default).
...
and open port 8224 on your firewall (or use -upnp).
